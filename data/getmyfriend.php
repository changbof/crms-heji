<?php
	...
	echo("<list>");
	$records = $db->get_all("select a.isblocked,a.groupid as gid,a.customname as cname,b.* from im_userfriend a inner join im_user b on a.friendid = b.userid where (a.userid = ".$_SESSION["userid"]." or a.userid=-1) ");
	if(count($records)>0){
