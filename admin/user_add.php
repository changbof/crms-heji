...
if (Common::isPost ()) {
	...
	if($exist){
		...
		$input_data = array ('user_name' => $user_name, 'password' => md5 ( $password ), 'real_name' => $real_name, 'mobile' => $mobile, 'email' => $email, 'user_desc' => $user_desc, 'user_group' => $user_group,'ext' => $ext );
