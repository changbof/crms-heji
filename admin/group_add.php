...
if (Common::isPost ()) {
	...
	if($exist){
		...
		$input_data = array ('group_name' => $group_name, 'group_desc' => $group_desc, 'group_role' => "1,5,17,18,22,23,24,25,30" ,'owner_id' => UserSession::getUserId() );
		...
		if ($group_id) {
			...
			Common::exitWithSuccess ('账号组添加完成','admin/groups.php');
		}
	}
}
