...
var Elem = {
	...
	Add:function(o)//为o元素追加子元素,可一次传进多个子元素
	{
		if(arguments.length==1)
		{
...
var Xml = {
	...
	{
		var t = $T(o,key)[0]&&$T(o,key)[0].firstChild?$T(o,key)[0].firstChild.nodeValue:"";
		return unescape(t);
	}
}
//******************************************
...
function Ajax()
{
	...
	this.send = function(_url,_content,_callback,_method,_isasync)
	{
		...
		if(Method=="POST")_req.setRequestHeader("Content-Type","application/x-www-form-urlencoded;charset=UTF-8");
...
function WebForm()
{
	...
	this.Show = function()
	{
		if(!$("windowContainer")) //最外层div
		{
			...
			Elem.Add(Elem.Add(
				Elem.New("div","windowContainerBorder","wContainerBorder"),
		...
		{
			this.ContentUrl = "layout/win"+_me.TypeStr.toLowerCase()+".htm";
		}
		...
		if(this.CanControl)
		{
			var oDivControl = Elem.New("div","win"+_me.TypeStr+"Control"+this.UserID,"wControl", "<div class=\"wControlMin\" onmouseover=\"this.scrollTop='17'\" onmouseout=\"this.scrollTop='0'\"><img src=\"images/"+_me.TypeStr.toLowerCase()+"controlmin.gif\" title=\"最小化\"/></div><div class=\"wControlClose\" onmouseover=\"this.scrollTop='17'\" onmouseout=\"this.scrollTop='0'\"><img src=\"images/"+_me.TypeStr.toLowerCase()+"controlclose.gif\" title=\"关闭\"/></div>");
