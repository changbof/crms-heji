...
class MenuUrl extends Base {
	...
	// 查询字段
	private static $columns = 'menu_id, menu_name, menu_url, module_id, is_show, online, shortcut_allowed,menu_desc,father_menu,menu_sort';	
	...
	/**
	* 批量修改菜单，如批量修改所属模块
	* menu_ids 可以为无key数组，也可以为1,2,3形式的字符串
	*/
