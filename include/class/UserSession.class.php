...
class UserSession{
	...
	public static function getExt(){
		$extension = '';
		$extension = $_SESSION[self::SESSION_NAME]['ext'];
		return $extension;
	}
  //最后一次客户养护期执行时间
	public static function  getCheckValidTime(){
			$checkTime = '';
			$checkTime = $_SESSION[self::SESSION_NAME]['checkvalid_date'];
			return $checkTime;
	}
    ...
    $user_info['checkvalid_date']=SystemParam::getValue("checkvalid_date");
