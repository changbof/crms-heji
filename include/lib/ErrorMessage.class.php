...
class ErrorMessage {
	...
	const HAVE_DICT		="该字典项下有子项被使用，不能删除；若要删除，请先将属于该组字典项的子项删除";
	...
	const ONLY_FOR_ADMIN = "此操作仅限管理员组使用";
	const ONLY_FOR_OWNER ="此操作仅限创建人使用";

	const KNOWLEDGE_NOT_EXIST 	="知识库不存在";
	const KNOWLEDGE_NOT_OWNER ="不能修改或删除其他人提交的知识库";
	const COMPLAINT_NOT_EXIST = "投诉记录不存在";

	const CUSTOMER_ALREADY_EXIST = "客户已存在，不能再次添加";
	const CUSTOMER_NOT_EXIST = "客户信息不存在";
	const DICT_NOT_EXIST = "字典信息不存在";
	const DISEASE_NOT_EXIST = "疾病知识库不存在";
	const PRODUCT_NOT_EXIST = "产品不存在";
}
