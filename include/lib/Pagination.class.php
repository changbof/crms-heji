...
class Pagination{
	...
	public static function showPager($link,&$page_no,$page_size,$row_count){
		...
		//$jump ="";
		$jump ="<li><a><form action='$url' method='GET' name='jumpForm' style='margin-bottom:0px;'><input type='text' name='page_no' value='$page_no' title='跳转到' style='margin-bottom: 2px; margin-top: 2px; width: 35px; height: 16px;'></form></a></li>";
