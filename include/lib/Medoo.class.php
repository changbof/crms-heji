...
class Medoo{
	...
	public function __construct($database){
		try {
			...
			$this->database_type=$DATABASE_LIST[$database]['database_type'];
            ...
            $this->database_name=$DATABASE_LIST[$database]['database_name'];
            ...
            {
            	case 'mysql':
            		$dsn = 'mysql:host=' . $this->server . (isset($port) ? ';port=' . $port : '') . ';dbname=' . $this->database_name;
                    break;
