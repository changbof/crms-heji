<?php /* Smarty version Smarty-3.1.15, created on 2014-09-17 00:05:52
         compiled from "D:\Server\www\crms\include\template\crms\orders_verify.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1056953fcbe0139c4d5-86533741%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1056953fcbe0139c4d5-86533741',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_53fcbe01413634_81366221',
  'variables' => 
  array (
    'orders' => 0,
    'a' => 0,
...
<?php if ($_valid && !is_callable('content_53fcbe01413634_81366221')) {function content_53fcbe01413634_81366221($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\Server\\www\\crms\\include\\config/../../include/lib/Smarty/plugins\\modifier.date_format.php';
...
');return false;" title="呼叫"><i class="icon-share-alt"></i></a><?php }?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="note" class="input-medium" <?php if ($_smarty_tpl->tpl_vars['a']->value) {?>readonly="readonly"<?php }?> value="<?php echo $_smarty_tpl->tpl_vars['orders']->value['verify_note'];?>
" />
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['orders']->value['express_no']!='') {?>&nbsp;&nbsp;&nbsp;&nbsp;运单号: <?php echo $_smarty_tpl->tpl_vars['orders']->value['express_no'];?>
<?php }?>
                    </div>
                </div>
                <div class="control-group">
 ...
 $_from = $_smarty_tpl->tpl_vars['shipping_detail']->value['data']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['foo']->key => $_smarty_tpl->tpl_vars['foo']->value) {
$_smarty_tpl->tpl_vars['foo']->_loop = true;
?>
                            <?php echo $_smarty_tpl->tpl_vars['foo']->value['time'];?>
  <?php echo $_smarty_tpl->tpl_vars['foo']->value['context'];?>
...
?>				 
            ...
            <div style="padding-top:15px;">
                ...
                <textarea rows="1" name="gift" class="span12"><?php echo $_smarty_tpl->tpl_vars['orders']->value['gift'];?>
</textarea>
            </div>
		</div>
	</div>
