<?php /* Smarty version Smarty-3.1.15, created on 2015-05-22 00:14:42
         compiled from "D:\Server\www\crms\include\template\header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:29349555e04721a7f35-72820209%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3a5ed1c969247f2a3583bef38fdde958d5bac3df' => 
    array (
      0 => 'D:\\Server\\www\\crms\\include\\template\\header.tpl',
      1 => 1414432157,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '29349555e04721a7f35-72820209',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_555e04721fcef9_33156187',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_555e04721fcef9_33156187')) {function content_555e04721fcef9_33156187($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
/assets/lib/bootstrap/css/bootstrap.css">
  <link rel="stylesheet" href="<?php echo @constant('ADMIN_URL');?>
/assets/lib/bootstrap/css/bootstrap-datetimepicker.min.css">
  <link rel="stylesheet" type="text/css" href="<?php echo @constant('ADMIN_URL');?>
/assets/lib/plugins/bootstrap-select/bootstrap-select.min.css">
  <link rel="stylesheet" href="<?php echo @constant('ADMIN_URL');?>
...
/assets/css/jquery-ui.css" />
  <link rel="stylesheet" href="<?php echo @constant('ADMIN_URL');?>
/assets/lib/plugins/jquery-spinner/bootstrap-spinner.css">
  <!-- link rel="stylesheet" href="<?php echo @constant('ADMIN_URL');?>
/assets/lib/plugins/jquery-dataTables/bootstrap-responsiv.css" -->
  <link rel="stylesheet" href="<?php echo @constant('ADMIN_URL');?>
/assets/lib/plugins/jquery-dataTables/dataTables.bootstrap.css">

  <script src="<?php echo @constant('ADMIN_URL');?>
/assets/lib/jquery-1.8.3.min.js" ></script>
  <script src="<?php echo @constant('ADMIN_URL');?>
/assets/lib/jquery.form.js"></script>
  <script src="<?php echo @constant('ADMIN_URL');?>
...
/assets/js/jquery-ui.js"></script>
  <script src="<?php echo @constant('ADMIN_URL');?>
/assets/js/jquery.autosize.js"></script>

  <script src="<?php echo @constant('ADMIN_URL');?>
/assets/lib/bootstrap/js/bootstrap-datetimepicker.min.js"></script>
  <script src="<?php echo @constant('ADMIN_URL');?>
/assets/lib/bootstrap/js/bootstrap-datetimepicker.zh-CN.js"></script>
  
  <!--script src="<?php echo @constant('ADMIN_URL');?>
/assets/interface/jquery-min.js"></script -->
  <script src="<?php echo @constant('ADMIN_URL');?>
/assets/interface/potato.js"></script>
  <!-- Demo page code -->
...
<script>
    //弹屏初始化
    function init_cc(){
      connect("<?php echo @constant('CALLCENTER_IP');?>
",function(msg){
        //log(msg);
        });
        setPop('<?php echo $_smarty_tpl->tpl_vars['user_info']->value['ext'];?>
',function(msg){
        var jsonobj = eval('('+msg+')');
        var extension = jsonobj.extension;
        var ext_no = '<?php echo $_smarty_tpl->tpl_vars['user_info']->value['ext'];?>
';
...
/crms/comecall.php?cometel="+cometel;
  jQuery.ajax({type:'GET',url:url,dataType:'html',success:function(data) {
    bb_ct = bootbox.dialog(data, [{
      ...
      "callback": function() {
		...
		var url = '<?php echo @constant('ADMIN_URL');?>
/crms/customer_modify.php?a=view&customerId='+customerId;
